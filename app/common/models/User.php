...
class User extends Zmodelbase
{
     ...
     *
     * @var string
     * @Column(column="head", type="string", length=200, nullable=false)
     */
    protected $head;
    ...
    public function initialize()
    {
        ...
        //$this->skipAttributes(array('email', 'password','roles','enabled'));

        //Skips only when inserting
        // $this->skipAttributesOnCreate(array('enabled'));

        //Skips only when updating
        // $this->skipAttributesOnUpdate(array('enabled','roles'));
