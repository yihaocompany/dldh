            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title"> <span class="icon"> <i class="icon-th"></i> </span>
                        <h5>管理员</h5>  <span class="pull-right"> <h5><button class="btn btn-primary btn-mini" id="0"  data-toggle="modal" data-target="#myModal" onclick="showmodal(this)">新增管理员</button></h5></span>
                    </div>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        ...
                                        <img src="<?= $item->head ?>" width="50" >
                                            <?php } else { ?>
                                            <img src="/upload/head/head.jpg" width="50" >
                                        <?php } ?>
                                  </td>
                                    <td><?= $item->username ?></td>
                                    <td><?= $item->email ?></td>
                                    <td>
                                        ...
                                        <div id="switch_<?= $item->id ?>"  class="switch" data-on-label="<i class='icon-ok icon-white'></i>" data-off-label="<i class='icon-remove'></i>">
                                            <input type="checkbox" id="enable_<?= $item->id ?>" <?php if ($item->enabled == 1) { ?> checked <?php } ?> />
                                        </div>
                                            <?php } else { ?>
                                            可用
                                        <?php } ?>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <input type="text" name="email" id="email" class="span3" placeholder="Email" />
                                ...
                                <div class="control-group" id="checkstatus">
...
<script>
    ...
    $('.switch').on('switch-change', function (e, data) {
        ...
        $.ajax(
            {
                data: {'enabled':enabled,'id':newstrid[0]},
                ...
                $(this).children('td').each(function(j){
                    if(j==0){
                        if( JSON.parse(obj.id)== JSON.parse($(this).text())){
                            ...
                            if(JSON.parse(obj.id)==JSON.parse('1')){
                                $('#cstatus').bootstrapSwitch('setState', true);
                                $('#cstatus').bootstrapSwitch('setActive', false);
                            }else{
